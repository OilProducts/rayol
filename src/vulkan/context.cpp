...
bool VulkanContext::draw_frame(bool& should_close_ui) {
    ...
    if (imgui_layer_) {
        ...
        // Top panel (roughly top two thirds)
        ...
        // Bottom panel (lower third) with centered Exit
...
bool VulkanContext::allocate_command_buffers() {
...
VkExtent2D VulkanContext::choose_extent(const VkSurfaceCapabilitiesKHR& capabilities) {
